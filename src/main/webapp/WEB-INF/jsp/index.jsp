...
<body>
	<header class="header">
		<div class="logo">
			<a href="/usuarios/index"> <img src="/static/imagenes/LogoTipo.png" alt="Logo" /> </a>
			<h1>Ticketerra</h1>
		</div>
		...
		<nav class="nav">
			...
			<a href="/ticket/crearTicket" class="nav-link" id="link-create">Crear Ticket</a>
			<c:if test="${not empty sessionScope.usuario}">
				<a href="/usuarios/logout" class="nav-link">Cerrar Sesión</a>
			</c:if>
	...
	<main>
		...
		<h2>La solución rápida y eficiente para gestionar <br /> tus problemas con eventos.</h2>
		<p style="font-size: 16px">
			...
			accesibilidad y más. Nuestro equipo está listo para<br /> ayudarte en cada paso del camino.
		</p>
		<a href="/usuarios/registrar"><button class="button">Registrarse</button></a>
	</main>

	<!-- Carrusel de Valoraciones -->
	<div id="valoracionesCarrusel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
		<div class="carousel-inner">
			<div class="carousel-item active">
				<div class="d-flex justify-content-center align-items-center flex-column text-center p-3">
					...
					<p class="comentario">"La página es muy fácil de usar y la atención al cliente es excelente. ¡Totalmente recomendada!"</p>
				</div>
			</div>
			<div class="carousel-item">
				<div class="d-flex justify-content-center align-items-center flex-column text-center p-3">
					...
					<div class="estrellas">★★★★★</div>
					<p class="comentario">"Me encanta lo rápido que se carga la página y lo intuitivo de su diseño. ¡Muy buena experiencia!"</p>
				</div>
			</div>
			<div class="carousel-item">
				<div class="d-flex justify-content-center align-items-center flex-column text-center p-3">
					...
					<div class="estrellas">★★★★☆</div>
					<p class="comentario">"Excelente plataforma, todo es rápido y sencillo. Estoy muy satisfecho con mi experiencia. ¡La recomiendo 100%!"</p>
				</div>
			</div>
			<div class="carousel-item">
				<div class="d-flex justify-content-center align-items-center flex-column text-center p-3">
					...
					<div class="estrellas">★★★★★</div>
					<p class="comentario">"Excelente servicio y funcionalidad. Me encanta cómo todo funciona a la perfección. ¡Totalmente recomendable!"</p>
				</div>
			</div>
		</div>
	</div>
